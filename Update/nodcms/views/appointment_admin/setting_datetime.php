<div class="portlet light">
    <div class="portlet-body">
        ...
        <div class="form-group">
            ...
            <label class="col-lg-10"><?php echo my_int_date(time()); ?> | <?php echo my_int_justTime(time()); ?></label>
        </div>
        <div class="form-group">
            <label class="control-label col-lg-2"><?php echo _l("Timezone", $this); ?></label>
            <div class="col-lg-10 col-sm-10">
                <select class="form-control input-large select2me" id="timezone" name="data[timezone]" data-placeholder="<?php echo _l("Select...", $this); ?>">
                    <option value=""></option>
        ...
        <?php
        mk_hselect("data[date_format]", _l('Date Format',$this), $date_format, "format", "name", isset($settings['date_format'])?$settings['date_format']:NULL, NULL, "style='max-width:200px;'");
        mk_hselect("data[time_format]", _l('Time Format',$this), $time_format, "format", "name", isset($settings['time_format'])?$settings['time_format']:NULL, NULL, "style='max-width:200px;'");
        mk_hsubmit(_l('Save',$this));
        mk_closeform();
        ?>
    </div>
</div>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/metronic/global/plugins/bootstrap-select/bootstrap-select.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/metronic/global/plugins/select2/select2.min.js"></script>
<script>
    $(function(){
        $("#timezone").val('<?php echo isset($settings['timezone'])?$settings['timezone']:'' ?>');
    });
</script>