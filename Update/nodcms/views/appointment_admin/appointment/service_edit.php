<div class="portlet">
    <div class="portlet-body">
        ...
        <div class="form-body">
            <?php
            mk_htext("data[service_name]",_l('Service Name',$this),isset($data['service_name'])?$data['service_name']:'');
            mk_hcheckbox("data[price_show]",_l('Show price',$this),(isset($data['price_show']) && $data['price_show']==0)?0:1);
            mk_hnumber("data[price]",_l('Service Price',$this),isset($data['price'])?$data['price']:'', "style='max-width:200px'");
