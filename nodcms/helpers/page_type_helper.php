 ...
 * Load TinyMCE editor
 */
function check_is_fields($key,$main_array,$field_name){
    return (isset($main_array[$key]["fields"][$field_name]))?1:0;
}
function get_attributes($key,$main_array,$attr_name){
    return (isset($main_array[$key][$attr_name]))?$main_array[$key][$attr_name]:0;
}
