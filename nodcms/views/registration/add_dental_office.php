...
<section class="register-dentist dentist_registration">
            ...
            <div class="registration-tabs">
                ...
                <div class="tab-content">
                    <div id="step1" class="tab-pane <?php echo($step == 1 ?'in active ':'');?>fade ">
                        <form id="update1" method="post" action="<?php echo base_url();?>Dental/addDentalOffice/2" role="form">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div id="step2" class="tab-pane <?php echo($step == 2 ?'in active ':'');?>fade">
                     <form id="update2" method="post" action="<?php echo base_url();?>Dental/addDentalOffice/3" role="form">
                        <div class="row">
                            <div class="col-md-6">
  ...
  $(function() {
    ...
    $(".timePicker-to").kendoTimePicker({format:"HH:mm"});
                    ...
                    <form id="update3" method="post" action="<?php echo base_url();?>Dental/addDentalOffice/4" role="form">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-sm-12">
                                ...
                                $practitioners = $query->result();?>
                                    <select id="" class="update_4 e9" name="treatment_practitioner[]" multiple="">
                                        ...
                                        <option value="<?= $practitioner->service_id;?>"><?= $practitioner->service_name;?></option>
                                        <?php endforeach;?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <form id="update4" method="post" action="<?php echo base_url();?>Dental/addDentalOffice/5" role="form">
                        <div class="row">
                            <div class="col-md-2">
...
$(document).ready(function(){
  $(".e9").select2({
    ...
    $('.'+formid).each(function(i,v){
     ...
     url = "<?php echo base_url();?>Dental/addDentalOffice/<?php echo $step;?>";
     $.ajax({
          url: url,
          type: "POST",
          data: formData,
...
<section class="register-dentist dentist_registration">
  ...
  $(function() {
    ...
    $(".timePicker-to").kendoTimePicker({format:"HH:mm"});
                    ...
                    <form id="update4" method="post" action="<?php echo base_url();?>Dental/addDentalOffice/5?<?php if($this->input->get('add') == "treatment"){ echo "add=".$this->input->get('add'); } ?>" role="form">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="treatment-tabs">
                                    <ul class="nav nav-tabs">
...
$(document).ready(function(){
  $(".e9").select2({
    ...
    $('.'+formid).each(function(i,v){
     ...
     url = "<?php echo base_url();?>Dental/addDentalOffice/<?php echo $step;?>?<?php if($this->input->get('add') == "treatment"){
			echo "add=treatment";
		} ?>";
     $.ajax({
          url: url,
