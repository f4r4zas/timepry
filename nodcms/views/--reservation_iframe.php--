...
//            url += encodeURIComponent(filter_search);
    ...
    <footer>
        <div class="text-center"><?=isset($settings["options"]["company"])?$settings["options"]["company"]:$settings["company"]?> <i class="fa fa-copyright"></i> <?php echo date("Y")?> <a href="http://codecanyon.net/item/appointment-management-system-nodaps/16197805" target="_blank" title="Purchase NodAPS just $24">Purchase NodAPS</a></div>
    </footer>
</body>
</html>