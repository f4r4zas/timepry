...
<!--    <link rel="stylesheet" type="text/css" href="--><?php //echo base_url(); ?><!--assets/metronic/global/plugins/jquery-ui/jquery-ui-1.10.3.custom.min.css"/>-->
    ...
    <link href="<?php echo base_url(); ?>assets/metronic/admin/pages/css/coming-soon.css" rel="stylesheet" type="text/css"/>
...
<body>
    ...
    <script src="<?php echo base_url(); ?>assets/metronic/admin/pages/scripts/tasks.js" type="text/javascript"></script>
    ...
    <script>
        ...
        $.backstretch([
            "<?php echo base_url(); ?>assets/metronic/admin/pages/media/bg/1.jpg",
            "<?php echo base_url(); ?>assets/metronic/admin/pages/media/bg/2.jpg",
            "<?php echo base_url(); ?>assets/metronic/admin/pages/media/bg/3.jpg",
            "<?php echo base_url(); ?>assets/metronic/admin/pages/media/bg/4.jpg"
        ], {
            fade: 1000,
            duration: 10000
        });
