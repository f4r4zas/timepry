            ...
            <table class="table table-striped table-bordered table-advance table-hover">
                ...
                for($i=0;$i<count($data);$i++){ ?>
                 <?php   $this->db->select('*');
                                    ...
                                    $this->db->where('provider_id',$this_provider_id);
                                    $this->db->where('day',$days[$i]);
                                    $check_office = $this->db->get()->result();
                                    
                                    //print_r($days[$i]);
                                    if($check_office[0]->closed == 0):
                            ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group" style="display: none;">
                    ...
                    <input type="text" class="form-control input-sm number-input" value="1" id="customer" name="customer" style="display: inline-block;width: 100px">
                ...
                <div class="form-group" style="display: none;">
                    ...
                    <input type="text" class="form-control input-sm number-input" id="period" name="period" value="15" style="display: inline-block;width: 100px;">
