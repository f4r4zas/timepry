        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject bold"><?php echo _l('Last Registered Patients', $this); ?></span>
                </div>
                <div class="actions">
    ...
    <div class="col-md-6">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <i class="icon-users"></i>
                    <span class="caption-subject bold"><?php echo _l('Last Registered Dentists', $this); ?></span>
                </div>
            ...
            <div class="portlet-body">
                <?php if(isset($dentists) && count($dentists)!=0){ $i=0; ?>
                    <table class="table">
                        <thead>
                        <tr>
                            <th><?php echo _l("Email",$this); ?></th>
                        ...
                        <?php foreach($dentists as $item){ $i++; ?>
                            <tr>
                                <td>
                                    <?php echo $item["email"]; ?>
                                </td>
