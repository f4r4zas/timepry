                                    ...
                                    <div role="tabpanel" class="tab-pane" id="langtab<?php echo $item["language_id"]?>">
                                        ...
                                        if(isset($auto_emails) && count($auto_emails)!=0){
                                            foreach($auto_emails as $key=>$val){
                                                mk_vtextarea_shortkeys($key.$item["language_id"],"data[auto_messages][".$item["language_id"]."][$key]",_l($val['label'],$this)." (".'<img src="'.base_url().$item["image"].'" style="width:18px;"> '.$item["language_name"].")",isset($auto_messages_data[$item["language_id"]])?$auto_messages_data[$item["language_id"]][$key]:"",'rows="12"',$val['keys']);
                                            }
                                        }
                                        ?>
                                    </div>
