...
<div class="row">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class=" form">
                    ...
                    mk_hurl_upload("data[default_image]",_l('Default Image',$this),isset($settings['default_image'])?$settings['default_image']:'',"default_image");
    ...
    mk_popup_uploadfile(_l('Default Image',$this),"default_image",$base_url."upload_image/1/");
    ?>
</div>
