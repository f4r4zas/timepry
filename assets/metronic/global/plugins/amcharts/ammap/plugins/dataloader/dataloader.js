...
AmCharts.addInitHandler( function ( chart ) {
  ...
  if ( 'stock' === chart.type ) {
    ...
    setTimeout( function () {
      ...
      for ( var x = 0; x < chart.dataSets.length; x++ ) {
        ...
        if ( undefined !== ds.dataLoader && undefined !== ds.dataLoader.url ) {
          ...
          ds.dataDental Office = [];
          applyDefaults( ds.dataLoader );
          loadFile( ds.dataLoader.url, ds, ds.dataLoader, 'dataDental Office' );
    ...
    chart.dataDental Office = [];
    loadFile( l.url, chart, l, 'dataDental Office' );
